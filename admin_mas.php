   ...
   <div class="info">
      ...
      <section class="form-container">
            ...
            <form action="add_image.php" method="post" enctype="multipart/form-data">
               <h3>Add new Advertisement to web-site</h3>
               
               <p>Add first image <span>*</span></p>
               <input type="file" name="img3"  class="box" style="width:500px;">

               <p>Add Description to first image: <span>*</span></p>
               <input type="text" name="text1"  class="box" style="width:500px; height:200px">

               <p>Add second image <span>*</span></p>
               <input type="file" name="img2"  class="box" style="width:500px;"> 

               <p>Add Description to second image: <span>*</span></p>
               <input type="text" name="text1"  class="box" style="width:500px; height:200px">

               <p>Add third image <span>*</span></p>
               <input type="file" name="img3"  class="box" style="width:500px;">
            
               <p>Add Description to third image: <span>*</span></p>
               <input type="text" name="text1"  class="box" style="width:500px; height:200px">


               <input type="submit" value="add_image" name="submit" class="btn" style="width:500px;">
